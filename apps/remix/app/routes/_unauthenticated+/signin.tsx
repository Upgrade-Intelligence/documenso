...
import {
  getPrimaryAllowedAuthDomain,
  isGoogleOAuthOnlyEnabled,
...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  const isGoogleOAuthOnly = isGoogleOAuthOnlyEnabled();
  const allowedGoogleAuthDomain = getPrimaryAllowedAuthDomain();
    ...
    <div className="w-screen max-w-lg px-4">
      <div className="z-10 rounded-xl border border-border bg-neutral-100 p-6 dark:bg-background">
        ...
        <SignInForm
          ...
          isGoogleOAuthOnly={isGoogleOAuthOnly}
          allowedGoogleAuthDomain={allowedGoogleAuthDomain}
